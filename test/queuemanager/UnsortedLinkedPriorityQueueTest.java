...
public class UnsortedLinkedPriorityQueueTest extends PriorityQueueTest {
    ...
    public void testAddNames() throws Exception
    {
        ...
        String expResult = "[(Billy, 7), (Mary, 21), (John, 39), (Susan, 54)]";
        String result = instance.toString();
        assertEquals(expResult, result);
    }
    ...
    public void testAddNoOrder() throws Exception
    {
        ...
        String expResult = "[(4, 4), (2, 2), (1, 1), (5, 5), (3, 3)]";
        String result = instance.toString();
        assertEquals(expResult, result);
    }
    ...
    public void testRemove() throws Exception
    {
        ...
        String expResult = "[(4, 4), (2, 2), (1, 1), (3, 3)]";
        String result = instance.toString();
        assertEquals(expResult, result);
    }
    ...
    public void testRemoveAdd() throws Exception
    {
        ...
        String expResult = "[(6, 6), (4, 4), (2, 2), (1, 1), (3, 3)]";
        String result = instance.toString();
        assertEquals(expResult, result);
    }
